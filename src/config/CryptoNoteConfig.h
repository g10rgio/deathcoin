...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 494424;
...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(7500000000000);
...
*/
const char     GENESIS_COINBASE_TX_HEX[]                     = "012801ff00019dd20d02d1f060b45b9fc59da7730429063ec8e562ce7781bb7db033509d6955645f143b21018185bf9f36b52a2cfefc0cc7d09c5c04b9fb3b2cb5788fbaa56af6ba59363915";
static_assert(sizeof(GENESIS_COINBASE_TX_HEX)/sizeof(*GENESIS_COINBASE_TX_HEX) != 1, "GENESIS_COINBASE_TX_HEX must not be empty.");

/* This is the unix timestamp of the first "mined" block (technically block 2, not the genesis block)
   You can get this value by doing "print_block 2" in TurtleCoind. It is used to know what timestamp
   to import from when the block height cannot be found in the node or the node is offline. */
const uint64_t GENESIS_BLOCK_TIMESTAMP                       = 1544910855;
...
const char     CRYPTONOTE_NAME[]                             = "DeathCoin";
...
const int      P2P_DEFAULT_PORT                              =  45337;
const int      RPC_DEFAULT_PORT                              =  45338;
const int      SERVICE_DEFAULT_PORT                          =  8075;
...
{
    {  0x64, 0x65, 0x61, 0x74, 0x68, 0x73, 0x63, 0x6f, 0x69, 0x6e, 0x64, 0x65, 0x61, 0x74, 0x68, 0x73  }
};
